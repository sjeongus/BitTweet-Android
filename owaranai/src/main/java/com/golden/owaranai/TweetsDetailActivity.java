...
/**
 * An activity representing a single Tweets detail screen. This
 * activity is only used on handset devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link TweetsListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link TweetsDetailFragment}.
 */
public class TweetsDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(TweetsDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(TweetsDetailFragment.ARG_ITEM_ID));
